            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (h, params) => {
                        return h('span', {
                            attrs: {
                                style:'color:' + (params.row.type != 3 && "red;")
                            }
                        },params.row.type == "3" ? "已爬取":"未爬取")
                    }
                },
                {
                    title: '小说状态',
                    ...
                    render: (h, params) => {
                        return h('div', [
                            h('span', {
                                attrs: {
                                    style:'color:' + (params.row.bookStatus != 1 && "red;")
                                }
                            },params.row.bookStatus == "1" ? "连载":"完本"),
                            h('a', {
                                attrs: {
                                    href:'javascript:void(0);',
                                    style:"color:" + (params.row.bookStatus == 1 && "red;")
                            ...
                            },params.row.bookStatus == "1" ? "(转完本)":"(转连载)")
